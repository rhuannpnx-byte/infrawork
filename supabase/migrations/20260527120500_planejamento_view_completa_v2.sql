-- InfraWork — Planejamento: vw_planejamento_tarefa_completa v2 (com perfil)
--
-- Recria a view com:
--   + perfil_default + usa_perfil_customizado (colunas novas de planejamento_tarefa).
--   + perfil_semanas: jsonb_agg ordenado por semana_segunda asc.
--   (Eixo espacial ja foi adicionado na 120010; preservado aqui.)
--
-- O JOIN com obras ja existe (necessario pra unidade_espaco_efetiva).
-- A view continua security_invoker=true — RLS de cada tabela base propaga
-- pro caller.

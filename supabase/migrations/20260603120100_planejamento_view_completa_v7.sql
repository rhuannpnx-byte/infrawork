...
-- vw_planejamento_tarefa_completa v7.
--
-- Mudança em relação à v6 (20260602120200):
--   + expõe qtd_link (vinculação de quantidade_alocada a métrica do template
--     de quantidades do trecho)
--
-- Estrutura idêntica à v6 — só adiciona uma coluna.

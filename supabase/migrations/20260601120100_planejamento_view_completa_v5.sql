...
-- vw_planejamento_tarefa_completa v5.
--
-- Mudanças em relação à v4 (20260530130600):
--   + expõe early_start, early_finish, late_start, late_finish
--   + expõe total_float, free_float, is_critico
--
-- DROP CASCADE necessário porque a assinatura da view muda. Quaisquer views
-- dependentes (curvas, dashboards) que caírem pelo CASCADE devem ser
-- recriadas — checar acompanhamento_views_enriquecidas e dashboard_views.
...
select
  ...
  -- Custo total pondera por quantidade_alocada (rateio correto entre N tarefas).
